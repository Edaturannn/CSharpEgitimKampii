...
namespace _03_MakingDecision
{
    internal class Program  // Programın başlayacağı ilk sınıf.
    {
        static void Main(string[] args) //Method. 
        {
            ...
            //if (password == "abcd") //Girilen password abcd ye eşit ise
            //{
            ...
            //string result = "Hatalı"; //Eğerki hiç bir if ‘e girmese sonuc bu yazacak ekranda başlangıç değeri….
            ...
            #region Char Değişkeni İle Bir Örnek
